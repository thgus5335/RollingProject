...
class Toast {
  ...
  addSuccess = message => {
    const id = v4();
    if (this.TOAST_QUEUE.filter(toast => toast.message === message).length > 0) {
      return;
    }
    ...
    this.ROOT_ELEMENT.render(<ToastMessage messages={this.TOAST_QUEUE} closeMessage={this.removeToast} />);
